...
class test_map_transform: public ::testing::Test
{
protected:
...
TEST_F(test_map_transform, no_effect_int)
{
...
TEST_F(test_map_transform, no_effect_string)
{
...
TEST_F(test_map_transform, copy_move_no_effect)
{
...
TEST_F(test_map_transform, 2_copy_move_no_effect)
{
    int& count = call_count<copy_move_counter>;
    reset<copy_move_counter>();
...
TEST_F(test_map_transform, swap_int_string)
{
...
TEST_F(test_map_transform, int_string_to_int_int)
{
    ...
    EXPECT_EQ(count, 1);
    EXPECT_EQ(call_args<int>.size(), 2);
    EXPECT_EQ(call_args<int>.front(), 55);
    EXPECT_EQ(call_args<int>.back(), 5);
    ...
    EXPECT_EQ(*std::next(call_args<int>.begin(), 2), 66);
    EXPECT_EQ(call_args<int>.back(), 6);
    EXPECT_EQ(call_args<std::string>.size(), 0);
}

TEST_F(test_map_transform, int_string_to_string_string)
{
    ...
    EXPECT_EQ(call_args<std::string>.size(), 2);
    EXPECT_EQ(call_args<std::string>.front(), "first");
    EXPECT_EQ(call_args<std::string>.back(), "5");
    ...
    EXPECT_EQ(*std::next(call_args<std::string>.begin(), 2), "second");
    EXPECT_EQ(call_args<std::string>.back(), "6");
}

TEST_F(test_map_transform, int_string_to_string_string_lambda)
{
    int& count = call_count<std::string, std::string>;
    reset<std::string, std::string>();
    reset<int>();
...
TEST_F(test_map_transform, int_string_to_string_string_mutable_lambda)
{
    int& count = call_count<std::string, std::string>;
    reset<std::string, std::string>();
    reset<int>();
...
TEST_F(test_map_transform, int_string_to_string_string_functor)
{
    int& count = call_count<std::string, std::string>;
    reset<std::string, std::string>();
    reset<int>();
...
TEST_F(test_map_transform, int_string_to_string_string_non_const_functor)
{
    int& count = call_count<std::string, std::string>;
    reset<std::string, std::string>();
    reset<int>();
